...
window.app.directive('managementMainsPowerOutlet', function (icons, devices, devicesAppData) {
    return {
        restrict   : 'AE',
        templateUrl: 'templates/directives/management-mains-power-outlet.html',
        scope      : {
            'deviceId': '@deviceId'
        },
        link       : function (scope) {
