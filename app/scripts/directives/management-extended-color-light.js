...
window.app.directive('managementExtendedColorLight', function (icons, devices, devicesAppData) {
    return {
        restrict   : 'AE',
        templateUrl: 'templates/directives/management-extended-color-light.html',
        scope      : {
            'deviceId': '@deviceId'
        },
        link       : function (scope) {
